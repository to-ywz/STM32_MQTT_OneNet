...
# define PRINT_MSG(fmt, args...) UARTx_printf(USART_DEBUG, fmt, ## args)
# define ERROR_MSG(fmt, args...) UARTx_printf(USART_DEBUG, fmt, ## args)
#else
...
typedef struct bhdr_struct {
    ...
    size_tlsf_t size;                /* bit 0 indicates whether the block is used and */
...
typedef struct TLSF_struct {
    ...
    size_tlsf_t used_size;
    size_tlsf_t max_size;
#endif
...
static __inline__ void MAPPING_SEARCH(size_tlsf_t * _r, int *_fl, int *_sl);
static __inline__ void MAPPING_INSERT(size_tlsf_t _r, int *_fl, int *_sl);
static __inline__ bhdr_t *FIND_SUITABLE_BLOCK(tlsf_t * _tlsf, int *_fl, int *_sl);
static __inline__ bhdr_t *process_area(void *area, size_tlsf_t size);
#if USE_SBRK || USE_MMAP
static __inline__ void *get_new_area(size_tlsf_t * size);
#endif
...
/******************************************************************/
size_tlsf_t init_memory_pool(size_tlsf_t mem_pool_size, void *mem_pool)
{
/******************************************************************/
    tlsf_t *tlsf;
    bhdr_t *b, *ib;
...
/******************************************************************/
size_tlsf_t add_new_area(void *area, size_tlsf_t area_size, void *mem_pool)
{
/******************************************************************/
...
/******************************************************************/
size_tlsf_t get_used_size(void *mem_pool)
{
/******************************************************************/
#if TLSF_STATISTIC
...
/******************************************************************/
size_tlsf_t get_max_size(void *mem_pool)
{
/******************************************************************/
#if TLSF_STATISTIC
...
/******************************************************************/
void *tlsf_malloc(size_tlsf_t size)
{
/******************************************************************/
    void *ret;
...
/******************************************************************/
void *tlsf_realloc(void *ptr, size_tlsf_t size)
{
/******************************************************************/
    void *ret;
...
/******************************************************************/
void *tlsf_calloc(size_tlsf_t nelem, size_tlsf_t elem_size)
{
/******************************************************************/
    void *ret;
...
/******************************************************************/
void *malloc_ex(size_tlsf_t size, void *mem_pool)
{
/******************************************************************/
    tlsf_t *tlsf = (tlsf_t *) mem_pool;
    bhdr_t *b, *b2, *next_b;
    int fl, sl;
    size_tlsf_t tmp_size;
...
/******************************************************************/
void *realloc_ex(void *ptr, size_tlsf_t new_size, void *mem_pool)
{
/******************************************************************/
    tlsf_t *tlsf = (tlsf_t *) mem_pool;
    void *ptr_aux;
...
/******************************************************************/
void *calloc_ex(size_tlsf_t nelem, size_tlsf_t elem_size, void *mem_pool)
{
/******************************************************************/
    void *ptr;
